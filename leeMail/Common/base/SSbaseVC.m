...
- (void)viewDidLoad {
    ...
    self.view.backgroundColor = [UIColor YQcolorWithR:245 G:245 B:245];
    self.page = 1;
    self.pageSize = 10;
...
- (void)isShowNavigationLine:(BOOL)isShow{
    if (isShow) {
        [self.navigationController.navigationBar setBackgroundImage:[self imageWithColor:[UIColor YQcolorWithR:221 G:221 B:221]] forBarPosition:UIBarPositionBottom barMetrics:UIBarMetricsDefault];
        [self.navigationController.navigationBar setShadowImage:[self imageWithColor:[UIColor YQcolorWithR:221 G:221 B:221]]];
    }else{
