...
//    [cancleBtn setTitle:@"取消" forState:UIControlStateNormal];
    ...
    if (self.datePickerMode == DatePickerDateMode) {
        ...
        [self setHourScrollView];
        [self setMinuteScrollView];
    }else if (self.datePickerMode == DatePickerDateYearMonthDayHourMode){
        [self setYearScrollView];
        [self setMonthScrollView];
        [self setDayScrollView];
        [self setHourScrollView];
...
- (void)setYearScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(leftAndRight, kTopViewHeight, (kScreen_Width-leftAndRight*2)*0.34, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerYearMonthMode) {
        ...
        yearScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.15, kTopViewHeight, kScreen_Width*0.2, kTimeBroadcastViewHeight)];
    }
...
- (void)setMonthScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(leftAndRight+(kScreen_Width-leftAndRight*2)*0.34, kTopViewHeight, (kScreen_Width-leftAndRight*2)*0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerMonthDayMode) {
        ...
        monthScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.35, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    }
...
- (void)setDayScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(leftAndRight+(kScreen_Width-leftAndRight*2)*0.67, kTopViewHeight, (kScreen_Width-leftAndRight*2)*0.33, kTimeBroadcastViewHeight)];
    } else if (self.datePickerMode == DatePickerMonthDayMode) {
        ...
        dayScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.5, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    }
...
- (void)setHourScrollView
{
    if (self.datePickerMode == DatePickerDateTimeMode) {
        ...
        hourScrollView = [[MXSCycleScrollView alloc] initWithFrame:CGRectMake(kScreen_Width*0.7, kTopViewHeight, kScreen_Width*0.15, kTimeBroadcastViewHeight)];
    }
...
//        self setAfterScrollShowView:<#(MXSCycleScrollView *)#> andCurrentPage:<#(NSInteger)#>
    }
    else
    {
        [okBtn setEnabled:YES];
